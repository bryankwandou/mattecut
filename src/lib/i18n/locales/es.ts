...
export const es: Dict = {
  meta: {
    title: "Mattecut — quita el fondo de tus imágenes sin subirlas",
    description:
  ...
  hero: {
    ...
    lead: "Mattecut recorta el fondo de las imágenes dentro del propio navegador. El archivo nunca sale de tu dispositivo, así que no hay cola, no hay cuota diaria y no tienes que fiarte de nadie sobre lo que pasa con tu foto.",
  ...
  studio: {
    ...
    auditTiny: "{kb} KB",
    auditMath:
      "La cifra de cada nivel de arriba suma el motor de {rt} MB a su modelo, porque eso es lo que realmente se descarga.",
    auditNote:
    ...
    sharpenNote:
      "Añade contraste de borde solo al color, nunca al borde del recorte. No recupera detalle que la cámara no grabó.",
    keepOriginal: "Conservar el fondo original",
    keepOriginalNote:
      "Exporta la foto tal como llegó: más nítida, sin recortar.",
    exportNote:
  ...
  bg: {
    ...
    cataloguePhotoCount:
      "{n} fotos, dominio público o CC0, servidas desde este sitio",
    catalogueTabGradients: "Colores",
    ...
    catalogueFailed:
      "No se pudo cargar la lista de fotos. Revise la conexión e inténtelo de nuevo.",
    creditShown:
      "Acredite esta foto dondequiera que comparta el resultado: {credit}",
    fitCover: "Rellenar",
    fitContain: "Ajustar",
  },
};
